...
namespace HTGSL
{
	public class FRCTN : Form
	{
		...
		private void FRCTN_Load(object sender, EventArgs e)
		{
		...
		private void okButton_Click(object sender, EventArgs e)
		{
			try
			{
				...
				SqlCommand sqlCommand = new SqlCommand("sp_call_top_n", this.conn);
				...
				sqlCommand.Parameters.Add("@TopN", SqlDbType.Int).Value = int.Parse(this.txtTopN.Text);
				sqlCommand.ExecuteNonQuery();
				string fileName = Application.StartupPath + "\\Reports\\CallTopN.xml";
				this.c1Report1.Load(fileName, "CallTopN");
				this.c1Report1.DataSource.ConnectionString = this.GetStringConnectFull();
				this.c1Report1.DataSource.RecordSource = "v_call_top_n";
				this.c1Report1.Fields["titleLbl"].Text = "Danh sách " + this.txtTopN.Text + " sự kiện lâu nhất";
				...
				using (C1PrintPreviewDialog c1PrintPreviewDialog = new C1PrintPreviewDialog())
				{
					...
					c1PrintPreviewDialog.Text = Resources.CallTopN;
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(FRCTN));
			...
			this.txtTopN = new TextBox();
			this.label3 = new Label();
			((ISupportInitialize)this.c1Report1).BeginInit();
			base.SuspendLayout();
			this.cancelButton.DialogResult = DialogResult.Cancel;
			this.cancelButton.Location = new Point(167, 107);
			...
			this.okButton.Location = new Point(66, 107);
			...
			this.Text = "Danh sách top các sự kiện";
			base.Load += new EventHandler(this.FRCTN_Load);
