...
namespace HTGSL
{
	public class F9002 : Form
	{
		...
		private void LoadData()
		{
			...
			this.conn.Open();
			this.ds = new DataSet();
			this.strSql = "SELECT [id],[time] FROM  [dbo].[MAIL_SCHEDULE]";
			this.da = new SqlDataAdapter(this.strSql, this.conn);
			this.da.Fill(this.ds, "MAIL_SCHEDULE");
			this.c1TrueDBGrid1.DataSource = this.ds.Tables["MAIL_SCHEDULE"];
		...
		private void TrueDBGridFormat()
		{
			...
			this.c1TrueDBGrid1.Columns["id"].Caption = "ID";
			this.c1TrueDBGrid1.Columns["time"].Caption = "Thời gian";
			this.c1TrueDBGrid1.Splits[0].DisplayColumns["time"].Width = 175;
			this.c1TrueDBGrid1.Splits[0].DisplayColumns["id"].Locked = true;
			this.CountFooterMaster();
		}
		private void CountFooterMaster()
		{
			this.c1TrueDBGrid1.Columns["time"].FooterText = this.c1TrueDBGrid1.RowCount.ToString();
		}
		private void butSave_Click(object sender, EventArgs e)
		{
			try
			{
				...
				this.da.Update(this.ds.Tables["MAIL_SCHEDULE"]);
				if (this.conn.State == ConnectionState.Open)
				{
					this.conn.Close();
				}
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(F9002));
			...
			this.c1TrueDBGrid1.Size = new Size(318, 185);
			...
			this.butSave.Location = new Point(230, 222);
			...
			this.groupBox1.Location = new Point(13, 205);
			this.groupBox1.Name = "groupBox1";
			this.groupBox1.Size = new Size(318, 9);
			this.groupBox1.TabIndex = 17;
			this.groupBox1.TabStop = false;
			base.AutoScaleDimensions = new SizeF(6f, 13f);
			base.AutoScaleMode = AutoScaleMode.Font;
			base.ClientSize = new Size(347, 259);
			...
			this.Text = "F9002 - Thiết lập thời gian gửi mail";
			base.Load += new EventHandler(this.F9002_Load);
