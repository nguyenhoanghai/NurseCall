...
namespace HTGSL
{
	public class F9994 : Form
	{
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(F9994));
			...
			this.c1TrueDBGrid1.Size = new Size(514, 258);
			...
			this.butSave.Location = new Point(426, 295);
			...
			this.groupBox1.Size = new Size(514, 9);
			this.groupBox1.TabIndex = 17;
			this.groupBox1.TabStop = false;
			base.AutoScaleDimensions = new SizeF(6f, 13f);
			base.AutoScaleMode = AutoScaleMode.Font;
			base.ClientSize = new Size(543, 332);
			...
			this.Text = "F9994 - Chức năng";
			base.Load += new EventHandler(this.F9994_Load);
		...
		private void F9994_Load(object sender, EventArgs e)
		{
			try
			{
				this.LoadData();
		...
		private void LoadData()
		{
			...
			this.conn.Open();
			this.ds = new DataSet();
			this.strSql = "SELECT [function_id],[function_name_vn], [sorting], [active] FROM  [dbo].[FUNCTIONS] ORDER BY [sorting]";
			this.da = new SqlDataAdapter(this.strSql, this.conn);
			this.da.Fill(this.ds, "FUNCTIONS");
			this.c1TrueDBGrid1.DataSource = this.ds.Tables["FUNCTIONS"];
		...
		private void TrueDBGridFormat()
		{
			...
			this.c1TrueDBGrid1.Splits[0].DisplayColumns["function_id"].Visible = false;
			this.c1TrueDBGrid1.Columns["function_name_vn"].Caption = "Tên chức năng";
			this.c1TrueDBGrid1.Columns["sorting"].Caption = "Thứ tự";
			this.c1TrueDBGrid1.Columns["active"].Caption = "Thạng thái";
			this.c1TrueDBGrid1.Splits[0].DisplayColumns["function_name_vn"].Width = 210;
			this.c1TrueDBGrid1.Splits[0].DisplayColumns["active"].Width = 130;
			this.c1TrueDBGrid1.Splits[0].DisplayColumns["sorting"].Width = 130;
			this.CountFooterMaster();
		}
		private void CountFooterMaster()
		{
			this.c1TrueDBGrid1.Columns["function_name_vn"].FooterText = this.c1TrueDBGrid1.RowCount.ToString();
		}
		private void butSave_Click(object sender, EventArgs e)
		{
			try
			{
				...
				this.da.Update(this.ds.Tables["FUNCTIONS"]);
				if (this.conn.State == ConnectionState.Open)
				{
					this.conn.Close();
				}
