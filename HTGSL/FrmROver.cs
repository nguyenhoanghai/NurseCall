    ...
    public partial class FrmROver : Form
    {
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                xlApp.Visible = false;
                xlSheet.Cells[1, 1] = "DANH SÁCH CÁC CUỘC GỌI LỚN HƠN HOẶC BẰNG " + txtMinus.Value + " PHÚT";
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("sp_call_wait_over_h", conn);
                ...
                cmd.Parameters.Add("@TimeInterval", SqlDbType.Int).Value = txtMinus.Value * 60;
        ...
        private void FrmROver_Load(object sender, EventArgs e)
        {
            this.Text = Properties.Resources.CallWaitOver;
            ...
            this.btnReport.Text = Properties.Resources.Export;
